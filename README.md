...
The last number of years has seen a rise in DIY skincare with more people wanting more control over the products they use and transparency over ingredients used in their products. This has allowed people to not only create products that are free from harsh chemicals and ingredients but also environmentally friendly and sustainable. This unfortunately has also led to mass amounts of misinformation online and harmful recipes floating around the internet. 

This site allows people to avoid the common pitfalls that arise when skincare making and provide simplified and factual information.  
...
- This gives users quick access to the navigations to allow for a better user experience.
- The header element contains the logo and the navigation bar.

![header element picture](assets/images/header-element.png)

#### Logo
- The logo showcases the site's name in large black writing. 

![logo picture](assets/images/logo.png)

#### Navigation bar
- The navigation bar has a hover function that changes the navigation colour to black with a white text and rounded border which follows the clean aesthetic of the site.
- It links to the home page, product types page, ingredients index page and best practice page.
- It appears on all four pages.

![navigation bar picture](assets/images/nav-bar.png)

### Hero Images
- Each page has its own hero image.
- Each page's respective hero image aims to reflect the page's content.
...
- The hero image shows a range of ingredients laid out on a table.
...
### Newsletter
- A signup form that allows people to subscribe to the newsletter and get new skincare making tips to their inbox.
...
- The links have a hover function that changes the learn more button colour to black and white.

![resources section picture](assets/images/resources.png)

### Product Types page
- The products types page starts with an introduction to the different types of cosmetic products.
- It then goes into each of the 3 cosmetic products oil, water and emulsion.
- Each product type section is accompanied by a respective image that showcases the different product types.
...
- The ingredients index page splits up the ingredients by three categories.
...
I also found an issue with certain sections of the site at certain widths which I had to make specified adjustments for. The resources section text overflowed at a certain width so I decreased the font size and increased the size of the container between 769px to 958px. The main content of the product types page also overflowed into each section so I removed the padding, increased the content width and added a margin within 769px to 875px. Making these changes allowed there to be smoother responsiveness as the site went from large screen, to medium, to small.
